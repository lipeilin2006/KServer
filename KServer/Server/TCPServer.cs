...
{
	public class TCPServer : KServer, IDisposable
	{
		private string host = "";
		private int port;
		...
		public override void Init()
		{
			...
			tcpsocket.Bind(new IPEndPoint(IPAddress.Parse(Host ?? "0.0.0.0"), Port));
			tcpsocket.Listen();
			...
			Console.WriteLine($"TCPServer started at {host}:{port}.");
		}
	...
	public class TCPConnection(Socket? s) : Connection
	{
